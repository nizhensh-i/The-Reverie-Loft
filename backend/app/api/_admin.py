...
admin_post_service = AdminPostService()
...
def post_init_summary():
    ...
    """
    try:
        result = admin_post_service.init_post_summaries()
...
def update_posts():
    ...
    try:
        result = admin_post_service.migrate_post_content_and_has_image()
...
def update_post_type():
    ...
    try:
        result = admin_post_service.update_post_type(
